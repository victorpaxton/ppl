...
param: paraminher paramout IDENTIFIER COLON vartyp;
paraminher: INHERIT | ;
paramout: OUT | ;
...
stmt: blockstmt | vardecl | assignstmt | ifstmt | forstmt | whilestmt | dowhilestmt | breakstmt | continuestmt | returnstmt | callstmt | specialcall | blockstmt ;
blockstmt: LP stmtlist RP;

assignstmt: lhs EQ expr SEMI;
lhs: IDENTIFIER | arrayele;
ifstmt: IF LB expr RB stmt elsestmt;
elsestmt: ELSE stmt | ;
